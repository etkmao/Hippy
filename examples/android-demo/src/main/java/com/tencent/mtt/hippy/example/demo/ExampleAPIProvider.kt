...
class ExampleAPIProvider : HippyAPIProvider {
    ...
    /**
     * register JavaScript call Java api-modules
     */
...
//            DemoTurboModule::class.java to Provider { DemoTurboModule(context) }
    ...
    /**
     * register Java call JavaScript api-modules
     */
    override fun getJavaScriptModules(): List<Class<out HippyJavaScriptModule>> {
        return emptyList()
    }
